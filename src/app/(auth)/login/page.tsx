    ...
    <div style={{
      ...
      <div className="card animate-fade" style={{ width: '100%', maxWidth: 400, padding: 32 }}>
        <div style={{ marginBottom: 28, textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', marginTop: 6 }}>Iniciá sesión para continuar</p>
        </div>
        ...
        <div style={{ marginTop: 20, textAlign: 'center', fontSize: 14, color: 'var(--text-tertiary)' }}>
          ¿No tenés cuenta?{' '}
          <a href="/register" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Registrate</a>
        </div>
      </div>
    </div>
  )
